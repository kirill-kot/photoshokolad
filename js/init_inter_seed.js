jQuery(document).ready(function ($) {
    ...
    var picSlider = new Swiper('.pictures-slider', {
        spaceBetween: 10,
        slidesPerView: 1,
        touchRatio: 0.2,
...
var timerId = setInterval(function() {
  var current_slide = textSlider.activeIndex;
if (current_slide === 0) {
    $('.text').slideDown({duration: 100, easing: 'easeInOutQuart'});
} else if (current_slide === 1) {
    $('.text').slideUp({duration: 100, easing: 'easeInOutQuart'});
}
}, 300);
